...
class SaveRequest:
    ...
    def __call__(self, request):
        ...
        if request.method == "POST":
            ...
            addressText = request.POST['addressText'] if 'addressText' in request.POST else None
        elif request.method == "GET":
            lat = request.GET['lat'] if 'lat' in request.GET else None
            lon = request.GET['lon'] if 'lon' in request.GET else None
            addressText = request.GET['addressText'] if 'addressText' in request.GET else None
