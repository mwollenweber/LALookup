...
class SoSElectedOfficial(models.Model):
    id = models.AutoField(primary_key=True)
    created = models.DateTimeField(auto_now=True, editable=True, db_index=True)
    ...
    gender = models.CharField(max_length=200, blank=True, null=True, db_index=True)
    party = models.CharField(max_length=200, blank=True, null=True, db_index=True)
